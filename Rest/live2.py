...
initial_threshold1 = 575
initial_threshold2 = 172

# Threshold sliders
threshold1_scale = Scale(root, label="Threshold1", from_=0, to=1000, orient="horizontal", length=300, command=update_image)
threshold1_scale.set(initial_threshold1)
threshold1_scale.pack()

threshold2_scale = Scale(root, label="Threshold2", from_=0, to=1000, orient="horizontal", length=300, command=update_image)
