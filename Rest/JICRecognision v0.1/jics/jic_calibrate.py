...
unit = "cm"
enable_size_1 = True
camera_size_1 = [39.3, 49.9]
world_size_1 = [194.0, 264.0]
enable_size_2 = True
camera_size_2 = [47.3, 36.4]
world_size_2 = [260.0, 195.0]
enable_size_3 = False
camera_size_3 = [1, 1]
world_size_3 = [1, 1]
...
def calibrate():
    ...
    try:
        div = 0
        width_scale_1 = camera_size_1[0] / world_size_1[0]
        height_scale_1 = camera_size_1[1] / world_size_1[1]
        if not (enable_size_1):
            width_scale_1 = 0
            height_scale_1 = 0
        else:
            div = div + 1
        width_scale_2 = camera_size_2[0] / world_size_2[0]
        height_scale_2 = camera_size_2[1] / world_size_2[1]
        if not (enable_size_2):
            width_scale_2 = 0
            height_scale_2 = 0
        else:
            div = div + 1
        width_scale_3 = camera_size_3[0] / world_size_3[0]
        height_scale_3 = camera_size_3[1] / world_size_3[1]
